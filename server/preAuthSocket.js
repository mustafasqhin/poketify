...
function keyCheck(key) {
    try {
        if (!validateKey(key)) {
            return { success: false, message: 'Geçersiz Anahtar', icon: '<i class="fa-solid fa-triangle-exclamation"></i>', blocked: false };
        }
        ...
        if (keyExists) {
            ...
            if (userCount >= max_users) {
                return { success: false, message: 'Yetkilendirilmemiş. Anahtar dolu', icon: '<i class="fa-solid fa-triangle-exclamation"></i>', blocked: true };
            }
            else {
                //allow user to join
            ...
            return { success: false, message: 'Anahtar mevcut değil', icon: '<i class="fa-solid fa-ghost"></i>', blocked: false };
        }
    }
    catch (err) {
        console.log(err);
